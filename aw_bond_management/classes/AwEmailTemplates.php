...
class AwEmailTemplates {
    ...
    public static function ifWinner($winner_id, $seller_id, $auctionID){
        ...
        if (!empty($seller_bonds)) {
            ...
            $seller_msg    .=               '<h3>'.$seller_id.', Your '.$bwic_title.' has closed and we wanted to inform you that the maximum bid was above your Reserve Price for the following bonds.</h3>';
            $seller_msg    .=           '</th>';
            $seller_msg    .=       '</tr>';
            $seller_msg    .=   '</thead>';
            $seller_msg    .=   '<tbody>';
            ...
            $seller_msg   .= '<tr><td colspan="5"><h3> You can view the bids in your <a href="'.site_url().'/seller-dashboard/" target="_blank">Dashboard</a>.  We will provide you with final trade confirmation and settlement instructions shortly.  Please do not hesitate to contact us if you have any questions or concerns.    Thank you, BEX Markets</h3></td></tr>';
            $seller_msg    .=   '</tbody>';
            $seller_msg    .=  '</table>';
    ...
    public static function ifNoWinner($winner_id, $seller_id, $auctionID){
        ...
        if (!empty($seller_bonds)) {
            ...
            $seller_msg    .=       '<tr>';
            $seller_msg    .=           '<th colspan="5">';
            $seller_msg    .=               '<h3>'.$seller_id.', Your '.$bwic_title.' has closed and we wanted to inform you that no bidder surpassed your "Reserve Price" for the following bonds. </h3>';
            $seller_msg    .=           '</th>';
            $seller_msg    .=       '</tr>';
            $seller_msg    .=   '</thead>';
            $seller_msg    .=   '<tbody>';
        ...
        if (!empty($user_bonds)) {
            ...
            foreach ($non_administrator as $all_user) {
                ...
                $user_msg   .= '<tr><td colspan="5"><h3>  You can review your bids in your  <a href="'.site_url().'/bid-history/" target="_blank">Dashboard</a>. Please do not hesitate to contact us if you have any questions or concerns.   Thank you, BEX Markets.</h3></td></tr>';
                $user_msg    .=   '</tbody>';
                $user_msg    .=  '</table>';
    ...
    public static function ifTied($user_id, $seller_id, $auctionID){
        ...
        if (!empty($seller_bonds)) {
            ...
            $seller_msg   .= '<tr><td colspan="5"><h3>  A best and final bid has been requested and you will be notified shortly of the results.  Please do not hesitate to contact us if you have any questions or concerns.   Thank you, BEX Markets.</h3></td></tr>';
            $seller_msg    .=   '</tbody>';
            $seller_msg    .=  '</table>';
        ...
        if (!empty($bidagain_bonds)) {
            ...
            $bidagain_msg   .= '<tr><td colspan="5"><h3>Please submit your best and final bid by '.$stamp.' at <a href="'.site_url().'/tiedbid/?id='.$user_id.'">Dashboard</a>Please do not hesitate to contact us if you have any questions or concerns.   Thank you, BEX Markets</h3></td></tr>';
            $bidagain_msg    .=   '</tbody>';
            $bidagain_msg    .=  '</table>';
