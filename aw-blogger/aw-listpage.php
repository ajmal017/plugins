...
class Site_List extends WP_List_Table {
	...
	public static function get_customers( $per_page = 5, $page_number = 1 ) {
		...
		// file_put_contents(dirname(__FILE__)."/orderby.log", print_r($sql, true),FILE_APPEND );
		// file_put_contents(dirname(__FILE__)."/orderby.log", print_r("\n\n	", true),FILE_APPEND );
