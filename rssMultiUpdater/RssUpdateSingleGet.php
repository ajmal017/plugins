...
class RssUpdateSingle {
    ...
    function updateBlog(){
        ...
        file_put_contents(dirname(__FILE__)."/logs/dataExecutoin.log", print_r(json_encode($data), true),FILE_APPEND );
        file_put_contents(dirname(__FILE__)."/logs/dataExecutoin.log", print_r("\n\n", true),FILE_APPEND );
