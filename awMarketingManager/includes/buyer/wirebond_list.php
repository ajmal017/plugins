...
class amm_wire_bond {
	...
	public static function amm_wire_bond_function() {
	...
	public static function showBonds( $postData ) {
        ...
        foreach ( $postData as $bond ) { 
            ...
            if (!empty($getTradeWinner)) {
                ...
                $html .=            '<td>
                						<a class="btn btn-default" href="#"  data-toggle="modal" data-target="#'.$bond->ID.'">Make Counter Offer</a>
				...
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h3 class="modal-title">
                            <strong>Make Offer for <?php echo $ticker." - ".$orig_size." MM";?></strong>
                        </h3>
					</div>
					...
					<div class="modal-body">
						...
						<button type="submit" class="place-market-bid btn btn-default">Make Your Offer</button>&nbsp;
